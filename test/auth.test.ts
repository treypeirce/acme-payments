...
describe("auth", () => {
  ...
  it("rejects tokens signed with a non-HS256 algorithm (CVE-2022-23539)", async () => {
    // requireAuth must restrict verify() to HS256 only. Without that, jsonwebtoken
    // 8.5.1 accepts other HMAC algorithms (e.g. HS384) signed with the same secret.
